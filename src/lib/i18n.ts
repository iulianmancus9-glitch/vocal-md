...
const RO = {
  ...
  specFreeA: 'Versurile și ', specFreeB: 'melodia întreagă', specFreeC: ' le asculți gratuit, înainte de plată.',
  ...
  noPayNow: 'Nu îți cerem nicio plată acum. Versurile și ascultarea melodiei rămân gratuite.',
  sending: 'Se trimite…',
  ...
  libEmptyText: 'Aici ajung melodiile pe care le faci de pe acest dispozitiv. Prima e la câteva minute distanță — versurile și ascultarea sunt gratuite.',
  ...
  demoText: 'Am pregătit două interpretări ale aceleiași piese. Ascultă-le pe amândouă, întregi. Varianta gratuită are o semnătură sonoră peste ea; fișierele pe care le primești după plată sunt curate.',
  ...
  get4: 'Melodia întreagă, de ascultat, cu o semnătură sonoră peste ea',
  freeNoteBold: 'Plătești doar dacă îți place.',
  freeNoteRest: ' Versurile și ascultarea melodiei întregi sunt gratuite. Cele 30 € le dai doar pentru fișierele curate, fără semnătura sonoră — și numai dacă te-a convins ce ai auzit.',
  ...
  how2Text: 'Versurile se generează în câteva secunde și le poți schimba. Apoi asculți melodia întreagă, în două interpretări, cu o semnătură sonoră peste ea. Până aici nu plătești nimic.',
  ...
  faq2Q: 'Cât durează?',
  faq2A: 'Versurile se scriu în câteva zeci de secunde, melodia într-un minut-două. Toată comanda, până la ascultare, durează sub zece minute. Melodia întreagă ajunge la tine imediat ce confirmăm plata — de obicei în câteva minute, cel târziu în câteva ore.',
  faq3Q: 'Trebuie să plătesc înainte s-o aud?',
  faq3A: 'Nu. Versurile și ascultarea melodiei întregi sunt gratuite. Plătești cele 30 € doar dacă îți place ce ai auzit — și abia atunci primești fișierele curate, fără semnătura sonoră.',
  ...
  metaDesc: 'Spui povestea, iar versurile și vocea sunt generate automat. Asculți melodia întreagă gratuit și plătești doar dacă îți place.',
  metaOgDesc: 'Versuri gratuite, melodia întreagă de ascultat gratuit, plătești doar dacă îți place.',
  metaLocale: 'ro_RO',
};
...
const EN: typeof RO = {
  ...
  specFreeA: 'The lyrics and ', specFreeB: 'the whole song', specFreeC: ' are yours to hear free, before you pay.',
  ...
  noPayNow: 'We ask for no payment now. The lyrics and listening to the song stay free.',
  sending: 'Sending…',
  ...
  libEmptyText: 'This is where the songs you make on this device end up. The first one is a few minutes away — the lyrics and listening to the song are free.',
  ...
  demoText: 'We have prepared two takes of the same song. Listen to both, in full. The free version carries an audio signature over it; the files you get after paying are clean.',
  ...
  get4: 'The whole song to listen to, with an audio signature over it',
  freeNoteBold: 'You pay only if you like it.',
  freeNoteRest: ' The lyrics and listening to the whole song are free. The €30 buys only the clean files, without the audio signature — and only if what you heard convinced you.',
  ...
  how2Text: 'The lyrics are generated in seconds and you can change them. Then you hear the whole song, in two takes, with an audio signature over it. Nothing is paid up to here.',
  ...
  faq2A: 'The lyrics take a few dozen seconds, the song a minute or two. The whole order, up to listening, takes under ten minutes. The full song reaches you as soon as we confirm your payment — usually within minutes, at most a few hours.',
  faq3Q: 'Do I have to pay before hearing it?',
  faq3A: 'No. The lyrics and listening to the whole song are free. You pay the €30 only if you like what you heard — and only then do you get the clean files, without the audio signature.',
  ...
  metaDesc: 'You tell the story, and the lyrics and the voice are generated automatically. Listen to the whole song for free and pay only if you like it.',
  metaOgDesc: 'Free lyrics, the whole song free to listen to, and you pay only if you like it.',
  metaLocale: 'en_GB',
};
