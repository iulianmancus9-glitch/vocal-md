...
const RO = {
  ...
  /* prețul, la vedere */
  priceTitle: 'Preț',
  priceSub: 'Un singur produs, un singur preț. Fără abonament.',
  priceUnit: 'plată unică',
  price1: 'Două fișiere MP3 — ambele interpretări, integral',
  price2: 'Se descarcă pe loc, din pagină și pe email',
  ...
  how3Text: 'Dacă îți place, plătești 30 € și primești pe loc două fișiere MP3 — în pagină și pe email.',
  ...
  faq2Q: 'Cât durează?',
  faq2A: 'Versurile se scriu în câteva zeci de secunde, melodia în două-trei minute. Toată comanda, de la primul pas până la fișierul descărcat, durează sub zece minute.',
...
const EN: typeof RO = {
  ...
  priceTitle: 'Pricing',
  priceSub: 'One product, one price. No subscription.',
  priceUnit: 'one-time payment',
  price1: 'Two MP3 files — both takes, in full',
  price2: 'Downloaded right away, from this page and by email',
  ...
  how3Text: 'If you like it, you pay €30 and get two MP3 files straight away — on the page and by email.',
  ...
  faq2A: 'The lyrics take a few dozen seconds, the song two to three minutes. The whole order, from the first step to the downloaded file, takes under ten minutes.',
