...
const RO = {
  ...
  spec2a: 'Descărcare ', spec2b: 'pe loc', spec2c: ', din pagină și pe email',
  ...
  demosTitle: 'Ascultă trei melodii făcute deja',
  demosSub: 'Toate au fost generate de aceleași modele care o vor face și pe a ta.',
  demoFoot: 'Versurile și vocea sunt generate de modele AI. Nu clonăm și nu imităm voci reale — vocile pe care le auzi sunt sintetice.',
  perk1: 'Versuri generate de AI',
  perk2: 'Două fișiere MP3, ale tale',
  perk3: 'Gata în câteva minute',

  /* melodiile demo */
  demo1Title: 'La mulți ani, Bogdan!', demo1Meta: 'Zi de naștere · pentru un prieten',
  demo2Title: 'Primul nostru dans',    demo2Meta: 'Nuntă · pentru miri',
  demo3Title: 'Puiul mamei',           demo3Meta: 'Din suflet · pentru mamă',
  ...
  emailModText: 'Doar pentru livrarea melodiei. Fără reclame nesolicitate.',
  ...
  libEmpty: 'Încă nu ai nicio melodie aici.',
  ...
  offerTitle: 'Melodia întreagă, gata de dăruit',
  ...
  offer4: 'Link dedicat cu piesa și versurile, gata de trimis persoanei dragi',
  confirming: 'Se confirmă plata…',
  buyCta: 'Primește melodia — 30 €',
  trust1: 'Plată securizată',
  trust2: 'Livrare instant',
  trust3: 'Descărcare nelimitată',
  paymentLate: 'Plata a fost trimisă, dar confirmarea întârzie. Îți scriem pe email imediat ce intră.',
...
const EN: typeof RO = {
  ...
  spec2a: 'Download ', spec2b: 'right away', spec2c: ', from this page and by email',
  ...
  demosTitle: 'Listen to three songs already made',
  demosSub: 'All of them were generated by the same models that will make yours.',
  demoFoot: 'The lyrics and the vocals are generated by AI models. We do not clone or imitate real voices — the voices you hear are synthetic.',
  perk1: 'Lyrics generated by AI',
  perk2: 'Two MP3 files, yours to keep',
  perk3: 'Ready in minutes',

  demo1Title: 'Happy birthday, Bogdan!', demo1Meta: 'Birthday · for a friend',
  demo2Title: 'Our first dance',        demo2Meta: 'Wedding · for the couple',
  demo3Title: "Mother's little one",     demo3Meta: 'Heartfelt · for a mother',
  ...
  emailModText: 'Only to deliver your song. No unsolicited marketing.',
  ...
  libEmpty: 'You have no songs here yet.',
  ...
  offerTitle: 'The whole song, ready to give',
  ...
  offer4: 'A dedicated link with the song and the lyrics, ready to send',
  confirming: 'Confirming payment…',
  buyCta: 'Get the song — €30',
  trust1: 'Secure payment',
  trust2: 'Instant delivery',
  trust3: 'Unlimited downloads',
  paymentLate: 'The payment went through, but the confirmation is taking a moment. We will email you as soon as it lands.',
